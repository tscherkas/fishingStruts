...
public class ShowEditableCatersAction extends ActionSupport implements ModelDriven< List<Cater> >{	
	...
	@Override
	@Action(value="catersEditor", results={
			@Result(name="success",location="catersUpdate.jsp"),
