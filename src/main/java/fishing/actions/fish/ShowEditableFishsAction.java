...
public class ShowEditableFishsAction extends ActionSupport implements ModelDriven< List<Fish> > {
	private FishListService fishListService;
	private List<Fish> model;
	@Action(value="FishsEditor", results={
			@Result(name="success",location="fishs.jsp"),
